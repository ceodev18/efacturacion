...
/* invoice2.1.xml.twig */
class __TwigTemplate_ae304a60b71e20142e5369b126ef0453c42e088b0df34a6376228ea26264f115 extends \Twig\Template
{
...
<Invoice xmlns=\"urn:oasis:names:specification:ubl:schema:xsd:Invoice-2\" xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\">
    ...
    ";
        ...
        // line 22
        echo "    ";
        if ($this->getAttribute(($context["doc"] ?? null), "observacion", [])) {
            // line 23
            echo "    <cbc:Note><![CDATA[";
            echo $this->getAttribute(($context["doc"] ?? null), "observacion", []);
            echo "]]></cbc:Note>
    ";
        }
        // line 25
    ...
    ";
        ...
        // line 189
        echo "    ";
        if ($this->getAttribute(($context["doc"] ?? null), "direccionEntrega", [])) {
            // line 190
            echo "        ";
            $context["addr"] = $this->getAttribute(($context["doc"] ?? null), "direccionEntrega", []);
            // line 191
            echo "        <cac:Delivery>
    ...
    ";
        ...
        // line 351
        echo "        ";
        if ($this->getAttribute(($context["doc"] ?? null), "mtoIvap", [])) {
            // line 352
            echo "        <cac:TaxSubtotal>
            <cbc:TaxableAmount currencyID=\"";
            // line 353
            echo $this->getAttribute(($context["doc"] ?? null), "tipoMoneda", []);
            echo "\">";
            echo call_user_func_array($this->env->getFilter('n_format')->getCallable(), [$this->getAttribute(($context["doc"] ?? null), "mtoBaseIvap", [])]);
            echo "</cbc:TaxableAmount>
            <cbc:TaxAmount currencyID=\"";
            // line 354
            echo $this->getAttribute(($context["doc"] ?? null), "tipoMoneda", []);
            echo "\">";
            echo call_user_func_array($this->env->getFilter('n_format')->getCallable(), [$this->getAttribute(($context["doc"] ?? null), "mtoIvap", [])]);
            echo "</cbc:TaxAmount>
            <cac:TaxCategory>
                <cac:TaxScheme>
                    <cbc:ID>1016</cbc:ID>
        ...
        // line 377
        echo "        ";
        if ($this->getAttribute(($context["doc"] ?? null), "icbper", [])) {
            // line 378
            echo "            <cac:TaxSubtotal>
                <cbc:TaxAmount currencyID=\"";
            // line 379
            echo $this->getAttribute(($context["doc"] ?? null), "tipoMoneda", []);
            echo "\">";
            echo call_user_func_array($this->env->getFilter('n_format')->getCallable(), [$this->getAttribute(($context["doc"] ?? null), "icbper", [])]);
            echo "</cbc:TaxAmount>
                <cac:TaxCategory>
                    <cac:TaxScheme>
                        <cbc:ID>7152</cbc:ID>
...
";
    ...
    {
        return new Source("", "invoice2.1.xml.twig", "/home/lunasystems/public_html/clientes/efacturacion/greenter/vendor/greenter/xml/src/Xml/Templates/invoice2.1.xml.twig");
    }
}
