...
if (!$id_guia) {
    header("Location: ver_guias_remision.php");
}
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-lg-3 buttons">
                <a href="ver_guias_remision.php" class="btn btn-success"><i class="fa fa-arrow-circle-o-left"></i> Ver Guias</a>
                <br>
                <a href="reg_guia_remision.php" class="btn btn-info"><i class="fa fa-plus"></i> Agregar Guia</a>
            </div>
            <div class="col-lg-9">
                <iframe class="col-lg-12" height="600px" src="../reports/rpt_documento_guia.php?id_guia=<?php echo $id_guia?>"></iframe>
            </div>
        </div>
    </div>
    <!--page header end-->
