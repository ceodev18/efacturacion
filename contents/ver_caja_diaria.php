    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" method="post" action="../controller/reg_apertura_caja.php">
...
<div class="modal fade" id="modal_reg_movimiento" tabindex="-1" role="dialog" aria-labelledby="modal_reg_movimiento">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="modal_pago_resultado"></div>
                <form role="form" class="form-horizontal" method="post" action="../controller/reg_movimiento_caja.php">
                    <div class="modal-form">
                    	<div class="form-group">
